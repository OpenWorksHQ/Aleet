        ...
        {menuOpen ? (
          ...
          >
            ...
            <Link
              href="/trip-history"
              role="menuitem"
              className="block px-4 py-2.5 text-[13px] text-aleet-text no-underline transition-colors hover:bg-aleet-cream md:hidden"
              onClick={() => setMenuOpen(false)}
            >
              Trip history
            </Link>

            <div className="mt-1 border-t border-aleet-border pt-1">
              <button
                type="button"
                role="menuitem"
