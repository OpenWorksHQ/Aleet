...
const MOCK_BOOKINGS: MyBooking[] = [
    {
        ...
        assignedDriver: { _id: "d1", name: "James Carter" },
    ...
    },
    {
        ...
        assignedDriver: { _id: "d2", name: "Michael Johnson" },
        addOns: [],
        regularPrice: 300,
        finalPrice: 300,
        savings: 0,
    ...
    },
    {
        ...
        quantity: 1,
        stops: [],
        assignedDriver: { _id: "d3", name: "Sarah Williams" },
        addOns: [],
        regularPrice: 200,
        finalPrice: 195,
        savings: 5,
    ...
    },
    {
        ...
        quantity: 1,
        stops: [],
        assignedDriver: { _id: "d4", name: "David Kim" },
        addOns: [],
        regularPrice: 220,
        finalPrice: 220,
        savings: 0,
    ...
    },
    {
        ...
        assignedDriver: { _id: "d5", name: "Elena Rossi" },
