                                        ...
                                        <div className="grid grid-cols-2 gap-x-8 gap-y-3 sm:grid-cols-3 lg:grid-cols-4">
                                            ...
                                            {trip.passenger ? (
                                                <div>
                                                    ...
                                                    <p className="text-sm text-text">{trip.passenger.name ?? "—"}</p>
                                                    ...
                                                    {(() => {
                                                        const passengerTel = toTelHref(trip.passenger.phone);
                                                        if (!passengerTel) return null;
                                                        return (
                                                            <a
                                                                href={passengerTel}
                                                                onClick={(e) => e.stopPropagation()}
                                                                className="mt-1 inline-flex items-center gap-1.5 text-xs font-medium text-gold hover:underline"
                                                            >
